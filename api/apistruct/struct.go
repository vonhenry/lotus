...
type FullNodeStruct struct {
	...
	Internal struct {
		...
		ChainBaseFeeIsLow             func(context.Context) (bool, error)                                                                                `perm:"read"`
...
func (c *FullNodeStruct) ChainBaseFeeIsLow(ctx context.Context) (bool, error) {
	return c.Internal.ChainBaseFeeIsLow(ctx)
}
